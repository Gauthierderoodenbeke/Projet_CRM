...
public class Communication implements Serializable {
	...
	@ManyToOne
	@JoinColumn(name="commercial", insertable=false, updatable=false)
	...
	public Communication(Date date, int heure, String sens, String moyCom,
		...
		this.commercial = commercial;
		this.contact = contact;
		this.id= new CleCommunication(contact.getIdContact(),commercial.getIdCommercial());
	}
